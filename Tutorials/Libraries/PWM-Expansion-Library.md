...
The Onion PWM Expansion C library is used in the implementation of [the `pwm-exp` command line tool.](../Expansions/Using-the-Servo-Expansion#using-the-command-line).
